			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<!--个人信息 -->
						<div class="info-main">
							<form class="am-form am-form-horizontal" action = "finishChInformation.jsp" method = "post" onsubmit = "return information_isvalid()">

								<div class="am-form-group">
									<label for="user-name" class="am-form-label">姓名</label>
									
									<div class="am-form-content">
										<input type="text" id="user-name2" name="newname" placeholder="name" onblur="verifyName()">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" name="newphone" placeholder="telephonenumber" type="tel" onblur="verifyPhone()">

									</div>
								</div>

								<div class="info-btn">
									<div type="submit" class="am-btn am-btn-danger">保存修改</div>
								</div>
