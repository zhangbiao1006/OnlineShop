						...
						<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
							...
							<li class="user-addresslist defaultAddr">
								...
								<p class="new-tit new-p-re">
									<span class="new-txt">${userNow.username }</span>
									<span class="new-txt-rd2">${userNow.userphone }</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">地址：</span>
										
										<span class="address">${userNow.useraddress }</span></p>
								</div>
								<div class="new-addr-btn">
									<a href="address.jsp#doc-modal-1""><i class="am-icon-edit"></i>编辑</a>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form action = "finishChAddress.jsp" method = "post" class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="user-phone" placeholder="必须为11位" type="email">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" name="newaddress" id="user-intro" placeholder="输入地址"></textarea>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a type="submit" class="am-btn am-btn-danger">保存</a>
			...
			<aside class="menu">
				<ul>
					<li class="person active">
						<a href="information.jsp"><i class="am-icon-user"></i>个人中心</a>
					</li>
					<li class="person">
