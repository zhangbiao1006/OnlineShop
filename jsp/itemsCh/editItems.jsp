...
<body> 
	...
	<div class="clear"></div>
<form  name="itemForm" id="itemForm" action="${pageContext.request.contextPath }/items/editItemsSubmit.action" method="post" >
...
<tr align="center">
	...
	<td width=100 height=80 align="left"><input type="text" name="catid" value="${itemsCustom.catid }"/></td>
</tr>
<tr align="center">
	<td width=100 height=80>商品名称</td>
	<td width=100 height=80 align="left"><input type="text" name="itemname" value="${itemsCustom.itemname }"/></td>
</tr>
<tr align="center">
	<td width=100 height=80>商品价格</td>
	<td width=100 height=80 align="left"><input type="text" name="itemprice" value="${itemsCustom.itemprice }"/></td>
</tr>
<tr align="center">
...
<tr align="center">
	...
	<td width=100 height=80 align="left"><input type="text" name="picture" value="${itemsCustom.picture }"/></td>
</tr>
<tr align="center">
	<td width=100 height=80>商品剩余数量</td>
	<td width=100 height=80 align="left"><input type="text" name="productnum" value="${itemsCustom.productnum }"/></td>
</tr>
